...
const { Proprietor, Mess } = require('../models');
...
const register = async (req, res, next) => {
  ...
  try {
    ...
    const messCreate = await commonService.createService(
      Mess,
      false,
      {},
      null,
    ...
    const user = await userService.createUser(
      { proprietorID: proprietorCreate._id, messID: messCreate._id, ...req.body },
      session
    );
